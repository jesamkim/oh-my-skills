...
# --- Defaults ----------------------------------------------------------------
MODEL="auto"             # CLI default; pin with --model for determinism
...
echo "Delegating review to Kiro (scope: $SCOPE_LABEL, model: $MODEL, effort: $EFFORT, agent: ${REVIEW_AGENT:-none/read-only})..." >&2
